...
Welcome to analyzer's tutorial! In this example we will analyze some sales data,
generating some descriptive graphics and tables. We will learn how to tell analyzer about
them so it can generate a web page and a Word document with them. The example full code
and data is accessible in the project's git repository (https://github.com/anarthal/analyzer), under
...
and will make analyzer generate a web with them.
...
That concludes analyzer's tutorial! You can check the aspect of the generated webpage here. (TODO: link).
